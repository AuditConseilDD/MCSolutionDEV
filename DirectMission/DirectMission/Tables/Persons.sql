CREATE TABLE [dbo].[Persons] (
    ...
    CONSTRAINT [FK_Persons_Cust_AccountStatus] FOREIGN KEY ([AccountStatus]) REFERENCES [dbo].[PersonAccountStatuses] ([PersonAccountStatusID]),
    ...
    CONSTRAINT [FK_Persons_Cust_PersonRoleID] FOREIGN KEY ([PersonRoleID]) REFERENCES [dbo].[PersonRoles] ([PersonRoleID]),
...
CREATE NONCLUSTERED INDEX [IFK_Persons_Cust_AccountStatus]
    ON [dbo].[Persons]([AccountStatus] ASC);
...
GO
CREATE NONCLUSTERED INDEX [IFK_Persons_Cust_PersonRoleID]
    ON [dbo].[Persons]([PersonRoleID] ASC);
